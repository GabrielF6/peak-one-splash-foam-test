    ...
    <>
      ...
      {!isTemplateTwo ? (
        ...
        <FormSectionHeader
          ...
          subtitle={`Where do we send your ${product.productName}?`}
        />
      )}
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="flex items-center space-x-2 mt-[30px] mb-[35px]">
          <span
            className={`w-[22px] h-[22px] rounded-[4px] border-[1px] border-black flex items-center justify-center bg-black" `}
          >
            <img
          ...
          <label htmlFor="custom-checkbox" className="text-[14px]  font-inter">
